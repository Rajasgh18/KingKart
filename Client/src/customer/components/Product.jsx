...
const Product = ({ details }) => {
    ...
    return (
        <div onClick={handleProduct} className='flex flex-col bottomAppear rounded hover:text-blue-500 text-slate-600 justify-start'>
            <img src={`/assets/productImg/${details.img[0]}`} className='p-2 cursor-pointer bg-white shadow-[0_0_12px_1px] shadow-slate-300 rounded transition-transform hover:scale-105 duration-300 object-contain w-[100%] h-[100%]' alt="" />
            <div className='flex flex-col md:gap-2 gap-1  p-3'>
