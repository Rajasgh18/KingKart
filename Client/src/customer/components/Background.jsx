...
const Background = () => {
    return (
        <div className='h-96 my-10 w-full gap-4 bg-gradient-to-r from-violet-500 to-blue-400 flex rounded-2xl'>
            <aside className='w-1/2 h-full flex flex-col items-start px-20 justify-center'>
            ...
            <aside className='w-1/2 h-full flex items-center justify-center'>
                <img src="/assets/images/headphones_a_4.webp" className='h-full w-full object-contain' alt="" />
            </aside>
        </div>
    )
}
