...
const ProductPage = () => {
  ...
  const handleCart = async () => {
    try {
      const id = "6482239d6c147161f40863b1";
      const res = await axios.put(`http://localhost:5000/api/user/cart-add/${id}`, { productId: productDetail._id })
  ...
  return (
    <section className='flex flex-col gap-10 flex-1'>
      {!isLoader1 ? <section className='mx-20 flex h-full bg-white shadow-md'>
