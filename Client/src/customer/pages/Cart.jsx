  ...
  return (
    <>
      {query === '?success=1'
        ...
        : (!isLoader ? <section className='lg:mx-20 md:mx-14 sm:mx-8 mx-4 my-4 flex-grow flex md:gap-4 gap-2'>
          ...
          <aside className='w-[30%] md:flex hidden flex-col gap-3 sticky leftAppear top-[4.8rem] h-fit '>
            <table className='w-full flex flex-col rounded bg-white shadow-[0_0_8px] p-4 shadow-slate-300'>
              ...
              <tbody className='flex flex-col lg:text-lg md:text-sm text-slate-600'>
                ...
                <tr className='flex lg:text-large md:text-base justify-between py-2 border-t-2'>
                  <td className='font-bold'>Total Amount</td>
                  <td className='font-viga'>Rs {itemDetails.offerPrice + itemDetails.deliveryCharge}</td>
                </tr>
              </tbody>
            </table>
